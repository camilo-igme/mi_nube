...
map.getView().fit([-2598536.577847, 2860867.699299, 1578926.098976, 5490790.669290], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Ejercicio 2 Unidad 9. Complemento qgis2web</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (52 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Visor desarrollado usando el complemteno "qgfis2web"';
            }
